#!/bin/bash
#SBATCH -o out/PCNO_train_1layer_log.out
#SBATCH --qos=low
#SBATCH -J lowrank
#SBATCH -p GPU80G
#SBATCH --nodes=1 
...
LOG_DIR="log_lowrank/1_1_5_2d_${KERNEL_TYPE}/beta${BETA_LOW}-${BETA_HIGH}/${LAYER_SIZES_STR}_${ACT}/"
mkdir -p ${LOG_DIR}

source activate pytorch 

python mpcno_lowrank_curve_beta_test.py \
