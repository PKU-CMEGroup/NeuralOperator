...
from geokno_adjust import compute_Fourier_modes, GeoKNO, GeoKNO_train
...
data = np.load("../data/airfoil_flap/geokno_triangle_data.npz")
...
train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = GeoKNO_train(
    x_train, aux_train, y_train, x_test, aux_test, y_test, config, model, should_print_L=True
)
