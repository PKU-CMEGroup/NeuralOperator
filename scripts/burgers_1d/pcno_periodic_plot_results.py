...
if __name__ == "__main__":
    ...
    model = setup_model(in_dim, out_dim, device, checkpoint_path = "PCNO_periodic_model.pth")
    ...
    axs[-1].legend()
    axs[0].legend()
    plt.savefig("PCNO_periodic_error.pdf")
    ...
    plt.show()
    plt.savefig("PCNO_periodic"+str(nT)+"steps.pdf")
