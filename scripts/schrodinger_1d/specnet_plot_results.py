...
from specnet_train import setup_model, preprocess_periodic_data
...
if __name__ == "__main__":
    ...
    model = setup_model(in_dim, out_dim, device, checkpoint_path = "Specnet_model_V"+V_type+".pth")
    ...
    axs[-1].legend()
    axs[0].legend()
    plt.savefig("Specnet_"+V_type+"_error.pdf")
    ...
    plt.show()
    plt.savefig("Specnet_"+V_type+str(nT)+"steps.pdf")
