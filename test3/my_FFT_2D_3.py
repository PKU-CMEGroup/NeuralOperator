...
from models.myGkNN import myGkNN
from models.myGkNN3 import myGkNN3
...
# load configs
###################################
with open('my_config_2D_3.yml', 'r', encoding='utf-8') as f:
...
###################################
model = myGkNN3(bases_list,**config_model).to(device)


print("Start training ", "layer_type: ",config_model["layer_types"])
train_rel_l2_losses, test_rel_l2_losses = FNN_train(
    x_train, y_train, x_test, y_test, config, model, save_model_name='model/darcy_421_r14_ep500_test3_nofc'
)
