...
from utils import FNN_train, compute_2dFourier_bases, compute_2dpca_bases

from MultiGkNN import MultiGalerkinNN, SimpleMultiGalerkinNN
from MultiGkNN1 import MultiGalerkinNN1
