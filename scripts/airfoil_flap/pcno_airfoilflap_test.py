...
parser.add_argument('--feature_type', type=str, default='mach', choices=['pressure', 'mach', 'both'],
...
save_model_name = f"PCNO_airfoilplap_{args.train_type}_{args.feature_type}_n{args.n_train}_Lx{args.Lx}_Ly{args.Ly}_{current_time}"
...
assert (
    ndata == ndata1 + ndata2
), "Expected ndata = ndata1 + ndata2. Ensure no data is omitted, or adjust the train and test index"
