...
# load data
###################################
data_path = "../data/advection_1d/advection1d_ds4_n512_t10.mat"

data = loadmat(data_path)
data_in = data["u"].T
data_out = data["v"].transpose(1, 0, 2)
grid = data["grid"].T
...
print("x_test.shape: ", tuple(x_train.shape))
print("y_test.shape: ", tuple(y_train.shape))
...
train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = GeoFNO_train(
    x_train, y_train, x_test, y_test, config, model, should_print_final=True
)
