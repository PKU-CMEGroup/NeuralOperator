            ...
            for k_max in k_max_array:
                for d_f in d_f_array:  
                    ...
                    for i_train_repeat in range(n_train_repeat):
                        ...
                        train_rel_l2_losses, test_rel_l2_losses, test_l2_losses, cost = FNN1d_train(x_train, y_train, x_test, y_test, config, save_model_name=prefix+"models/heat_FNO_"+str(i_train_repeat)+"_"+setup_info)
