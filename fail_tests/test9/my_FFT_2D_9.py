...
from models import  FNN_train, compute_2dFourier_bases, compute_2dpca_bases, compute_2dFourier_cbases,compute_H, count_params,myFNN_train
from models.Galerkin import GkNN
from models.myGkNN9 import myGkNN9
...
# load configs
###################################
with open('config_2D_9.yml', 'r', encoding='utf-8') as f:
...
###################################
model = myGkNN9(bases_list, H_in, H_out, **config_model).to(device)
print(count_params(model))

print("Start training ", "layer_type: ",config_model,config_train)
train_rel_l2_losses, test_rel_l2_losses = myFNN_train(
