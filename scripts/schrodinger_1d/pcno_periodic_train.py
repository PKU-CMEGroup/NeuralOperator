...
if __name__ == "__main__":
    ...
    train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = PCNO_train(x_train, aux_train, y_train, x_test, aux_test, y_test, config, model, save_model_name="./PCNO_periodic_model_V"+V_type)
