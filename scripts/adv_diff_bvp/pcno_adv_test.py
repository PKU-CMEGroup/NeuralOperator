...
print("features ", np.mean(features, axis=(0,1)), np.max(features, axis=(0,1)), np.min(features, axis=(0,1)))
...
k_max = 64
ndim = 1
train_sp_L = False #'independently'  # False , 'together' or 'independently'
