#!/usr/bin/env python3
"""Render the registered A32 affine shadow-tether rollout bundles."""
...
from scripts.time_dependent_no.evaluate_pcno_affine_shadow_tether_rollout import (
    ANIMATION_CONTRACT,
    ANIMATION_SCHEMA,
    RESULT_SCHEMA,
    WORKING_ID,
...
RENDER_SCHEMA = "pcno_sp19_affine_shadow_tether_animation_render_v1"
...
def _load_contract(
    ...
    if (
        ...
        raise ValueError("rollout is not the registered unrendered A32 execution")
    if (
        ...
        raise ValueError("animation manifest differs from the registered A32 contract")
    ...
    payload = with_payload_sha256(
        {
            ...
            "interpretation": (
                "Positive signed relative improvement means the A32 candidate has "
