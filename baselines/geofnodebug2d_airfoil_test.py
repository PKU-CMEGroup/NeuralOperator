...
from baselines.geofno_debug import  GeoFNO, GeoFNO_train, compute_Fourier_modes
...
kx_max, ky_max = 32, 16
ndim = 2
modes = compute_Fourier_modes(ndim, [kx_max,ky_max], [1.0,1.0])
modes = torch.tensor(modes, dtype=torch.float).to(device)
model = GeoFNO(ndim, modes, modes1=kx_max, modes2=ky_max,
