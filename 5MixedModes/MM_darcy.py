...
# load configs
###################################
with open("MMconfig_darcy1.yml", "r", encoding="utf-8") as f:
...
###################################
print("#" * 50)
print("Mixed modes Test for Darcy2d, choosing different diagonal width")
