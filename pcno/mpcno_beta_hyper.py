...
class HyperSpectralConv(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, modes, hyper_net, rank=8):
        ...
        # output dim = 3 * rank   (u_c, u_s, u_0 stacked)
...
class MPCNO_Beta(MPCNO):
    ...
    def __init__(
        ...
        for in_size, out_size in zip(layers, layers[1:]):
            ...
            new_sp_convs.append(
                HyperSpectralConv(in_size, out_size, modes, hyper_net, rank=rank))
