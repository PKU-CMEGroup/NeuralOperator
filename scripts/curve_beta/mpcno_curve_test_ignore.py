...
# 使用 beta 范围构造数据文件名（保留文件名中原有的空格格式）
data_file_path = data_path + f"/pcno_curve_data_1_1_5_beta({args.beta_low}, {args.beta_high})_2d_{args.kernel_type}_beta_random_panel_single.npz"
...
if n_two_circles_test > 0:
    # 同样修改 two_curves 文件路径
    data_file_path = data_path + f"/pcno_curve_data_1_1_5_beta({args.beta_low}, {args.beta_high})_2d_{args.kernel_type}_beta_random_panel_two_curves.npz"
...
print(f'beta_low = {args.beta_low}, beta_high = {args.beta_high}')  # 新增打印
