...
bases_pca_test, wbases_pca_test = compute_2dpca_bases(Np, k_max, L, pca_data)
bases_pca_test, wbases_pca_test = bases_pca.to(device), wbases_pca.to(device)

fig, ax = plt.subplots(ncols=5, nrows=1)
ax[0].imshow(bases_pca[..., 0], cmap="hot", interpolation="nearest")
