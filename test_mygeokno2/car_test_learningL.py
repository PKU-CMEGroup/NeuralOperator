...
from test_mygeokno2.geokno_learningL import compute_Fourier_modes, GeoKNO_learningL, opt_GeoKNO_train, GeoKNO_train
...
model = GeoKNO_learningL(ndim, modes,
...
print('lr_ratio:',config['train']['lr_ratio'])


train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = opt_GeoKNO_train(
