...
from tmp_airfoilflap.geokno_adjust import compute_Fourier_modes, GeoKNO, GeoKNO_train_surface_separate
...
train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = GeoKNO_train_surface_separate(
