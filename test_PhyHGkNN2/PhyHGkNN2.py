...
#compute pca bases
####################################
k_max_in = config_model['layer']["GkNN_mode_in"]
k_max_out = max(config_model['layer']["GkNN_mode_out"],config_model['layer']["GkNN_mode_out_phybases"])
...
bases_pca_in, wbases_pca_in = compute_2dpca_bases(Np , k_max_in , L,  pca_data_in)
bases_pca_in, wbases_pca_in = bases_pca_in.to(device), wbases_pca_in.to(device)

bases_pca_out, wbases_pca_out = compute_2dpca_bases(Np , k_max_out , L,  pca_data_out)
...
bases_list = [ bases_pca_out, wbases_pca_out, bases_pca_out,wbases_pca_out]
print('bases_list = [ bases_pca_out, wbases_pca_out, bases_pca_out,wbases_pca_out]')
###################################
