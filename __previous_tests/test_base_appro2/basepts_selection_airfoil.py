...
basepts = uniform_points([[-1,1],[-1,1]],400,2)
range_pts = [[-1,1],[-1,1]]
...
save_figure_basespts = 'figure/airfoil_baseselection/test_400squaresum/'
# num_plot_bases = 32
range_pts = [[-1,1],[-1,1]]
...
torch.save(model.basepts.detach().cpu(), 'para/airfoil/basepts_Gauss400_squaresum.pt')