...
bases_list = [ bases_pca_in_1, wbases_pca_in_1, bases_pca_in_2,wbases_pca_in_2, bases_pca_out, wbases_pca_out]
###################################
...
train_rel_l2_losses, test_rel_l2_losses = FNN_train(
    x_train, y_train, x_test, y_test, config, model, save_model_name='model/test6'
)
