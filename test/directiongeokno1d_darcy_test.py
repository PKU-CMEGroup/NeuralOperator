...
from directionGeoKNO2 import compute_Fourier_modes, directionGeoKNO2, GeoKNO2_train
...
print(f'k_max = {k_max}, kernel_modes = {kernel_modes}, directions_dim = {directions_dim}, directions_modes = {directions_modes}')
print('modes.shape:',modes.shape)
model = directionGeoKNO2(ndim, modes,kernel_modes,
               directions_dim,
               directions_modes,
...
config = {"train" : {"base_lr": base_lr, "weight_decay": weight_decay, "epochs": epochs, "scheduler": scheduler,  "batch_size": batch_size, 
        ...
        'plot': {'alpha':alpha, 'Nx':Nx,'Ny':Ny,'save_figure_hidden':save_figure_hidden,'plot_hidden_layers_num':plot_hidden_layers_num,'plot_directions_num':plot_directions_num}}

train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = GeoKNO2_train(
